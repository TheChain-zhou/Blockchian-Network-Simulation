...
public class Timer {   // time parameters
	...
	public static void runTask(){    // Task run
		if(taskQueue.size() > 0){
	...
	public static void removeTask(Task task){ // how to remove task
	...
	public static Task getTask(){  // to get the task
		if(taskQueue.size() > 0){
	...
	public static void putTask(Task task){  // put task

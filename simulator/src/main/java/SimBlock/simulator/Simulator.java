...
public class Simulator {
	private static ArrayList<Node> simulatedNodes = new ArrayList<Node>();  // list for simulatedNodes
	...
	public static void addNode(Node node){
		simulatedNodes.add(node);   //add node to the simulated list
	}
	...
	public static void arriveBlock(Block block,Node node){  //only record the latest 10 block info to save memory
	...
	public static void printPropagation(Block block,LinkedHashMap<Integer, Long> propagation){  // print block propagation time

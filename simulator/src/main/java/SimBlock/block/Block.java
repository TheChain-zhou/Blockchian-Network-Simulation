...
public class Block {   // All parameters about the block
	public int height;
	public Block parent;
	public Node minter;
	public long time;
	...
	public Block getBlockWithHeight(int height) {
		if (this.height == height) {
			return this;
		} else {   //原本｛｝里面只有  return this.parent.getBlockWithHeight(height);
	...
	public boolean isOnSameChainAs(Block block) {  // Check if they are the same block
		if (block == null) {
			return false;
